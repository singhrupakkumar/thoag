        ...
        <div class="row">
            <div class="col-md-12">
                <div class="page-headeing">
                    <h1 class="page-title"><i class="fa fa-bars" aria-hidden="true"></i>Blog</h1>
                </div>
...
<div class="content">
    ...
    <div class="main-content">
        ...
        <div class="btn-toolbar list-toolbar"> 
          <div class="add_new">
          <a style="float: left;" href="<?php echo $this->Html->url(array('controller' => 'Staticpages', 'action' => 'admin_addblog')); ?>"><span class="btn btn-primary"><i class="fa fa-plus"></i> Add New Blog</span></a>
          <?php echo $this->Form->create("Staticpage", array("action" => "admin_blogindex")); ?>
                        ...
                        <td><?php echo h($staticpage['Staticpage']['created']); ?>&nbsp;</td>
                               <!-- <td><?php if ($staticpage['Staticpage']['status'] == '0') { ?>
                                ...
                                <td class="actions">
                                    ...
                                    <?php echo $this->Html->link(__(''), array('action' => 'blogedit', $staticpage['Staticpage']['id']), array('class' => 'edit1 btn btn-default btn-xs fa fa-pencil','title'=>'Edit')); ?>
                                   ...
                                   /* if ($staticpage['Staticpage']['status'] == 0) {
                                        echo $this->Form->postLink((''), array('Controller' => 'Staticpages', 'action' => 'admin_activate', $staticpage['Staticpage']['id']), array('escape' => false, 'class' => 'active1 btn btn-default btn-xs fa fa-check', 'title' => 'Active'));
                                    } else {

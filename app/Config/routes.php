 ...
 */
	...
	Router::connect('/', array('controller' => 'products', 'action' => 'index'),array('routeClass' => 'I18nRoute')); 
        
	//Router::connect('/product/:slug', array('controller' => 'products', 'action' => 'view'), array('pass' => array('slug'),'routeClass' => 'I18nRoute'));
...
//Router::connect('/pages/*', array('controller' => 'pages', 'action' => 'display'),array('routeClass' => 'I18nRoute')); 
	Router::connect('/pages/*', array('controller' => 'pages', 'action' => 'display'),array('routeClass' => 'I18nRoute'));
        //pRouter::connect('/manager/newsletter', array('controller' => 'newsletters', 'action' => 'dashboard','manager' => true, 'plugin' => 'newsletter'));

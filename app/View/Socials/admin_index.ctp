<div class="socials index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $social['Social']['id']), array(), __('Are you sure you want to delete # %s?', $social['Social']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>

        ...
        <div class="row">
            <div class="col-md-12">
                <div class="page-headeing">
                    <h1 class="page-title"><i class="fa fa-bars" aria-hidden="true"></i>Add Blog</h1>
                </div>
            ...
            <?php $x=$this->Session->flash(); ?>
                    ...
                    <div class="form-group">
                      ...
                      <input type="hidden" class="form-control" name="data[Staticpage][position]" value="blog"> 
                    </div>
                    <div class="form-group">
                        <label>Title</label>
                    ...
                    <div class="form-group">
					 ...
					 <div class="form-group">
                        ...
                        <textarea rows="2" name="data[Staticpage][description_ar]" class="form-control" id="edi" ></textarea>
                    </div>

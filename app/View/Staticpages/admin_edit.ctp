    ...
    <div class="sec_inner">
        ...
        <?php echo $this->Form->create('Staticpage',array('id'=>'tab','type'=>'file')); ?> 
                    <div class="restaurants index">
                          ...
                          <?php echo $this->Form->select('position',array('about'=>'About Us','terms'=>'Term & Conditions',
                              'faq' => 'Faq','blog' => 'Blog','policy'=>'Caterer Policy','career'=>'Career','contact'=>'Contact Us','support'=>'Support')

<div class="restaurantsTypes index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $restaurantsType['RestaurantsType']['id']), array('class' => 'btn btn-default btn-xs')); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $restaurantsType['RestaurantsType']['id']), array('class' => 'btn btn-default btn-xs')); ?> 

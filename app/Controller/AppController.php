...
////////////////////////////////////////////////////////////
    public $components = array(
       ...
       public $helpers = array('Html','I18n.I18n');  
...
////////////////////////////////////////////////////////////
    public function beforeFilter() {
       ...
       $this->set("loggedusername", $loggedusername); 
        ...
        $this->set('base_url',Router::fullbaseUrl().'/thoag');
...
//$pos = strpos($mystring, $arabic);
//if ($pos === false) { 
    
    //$this->set('arabic',$eng);
// echo "The string '$arabic' was not found in the string '$mystring'";
//} else {
     
//echo "The string '$arabic' was found in the string '$mystring'"; 
...
//} 
   ...
   $client_id = '323825392115-4f8gq30trjk9in995ha06fkviier8mfo.apps.googleusercontent.com';
    ...
    public function baseurl(){
        return Router::fullbaseUrl().'/thoag';
    }

            ...
            <div class="col-md-12">
                ...
                <div class="page_content">
                    <div class="restaurants index">
                      <div style="padding-left: 0px;" class="col-sm-3"> <img style="width: 100%;" src="<?php echo $this->webroot."files/staticpage/".$staticpage['Staticpage']['image'];?>"  class="img-responsive" alt=""> </div>

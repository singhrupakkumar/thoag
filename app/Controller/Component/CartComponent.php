...
//////////////////////////////////////////////////
     ...
     * @return boolean|string
     */
    public function appadd($id, $quantity = 1, $productmodId = null, $uid = null, $sid = NULL,$parent_id=NULL,$order_type=null,$notes=null) {
//print_r($uid);
        if ($productmodId) {
            $productmod = ClassRegistry::init('Productmod')->find('first', array(
                'recursive' => -1,
        ...
        // Maintain session_id for app && web
//        $user_cart = ClassRegistry::init('Cart')->find('first', array(
//            'recursive' => -1,
//            'conditions' => array(
//                'Cart.uid' => $uid
//            )
//        ));
//        if($user_cart){
//            $sid= $user_cart['Cart']['sessionid'];
//        }
        // Maintain session_id for app && web ends
       ...
       // print_r($uid);print_r($sid); print_r($product['Product']['res_id']);
        $this->removeItemsAccToRestaurant($uid,$sid,$product['Product']['res_id']);

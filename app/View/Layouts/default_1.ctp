...
//                        });
            ...
            $(document).ready(function() {
             ...
             $('#tkchk').on("click",function(){
                ...
                $.post('http://rajdeep.crystalbiltech.com/cart_new/custom_cart/restaurants/filterrestype', {restype1:restype1,amt: amt, lat: lat, lng: lng, restype: restype}, function(d) {
                    var data = JSON.parse(d);
                    console.log(data);
                    console.log(data.Restaurant);
//                            console.log(data[1]);

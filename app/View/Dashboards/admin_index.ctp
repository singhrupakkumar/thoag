      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Total Caterers</span>
              <span class="info-box-number"><?php echo $total_caterer; ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
            ...
            <div class="col-md-6">
              ...
              <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">Latest Caterers</h3>
                ...
                <div class="box-body no-padding">
                  <ul class="users-list clearfix">
                      <?php foreach($latest_caterers as $member){ ?>
                    <li>
...
<!--                <div class="box-footer text-center">
                  <a href="javascript:void(0)" class="btn btn-sm btn-info btn-flat pull-right">View All Users</a>
                </div>-->
                <!-- /.box-footer -->
              </div>
              <!--/.box -->
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <ul class="products-list product-list-in-box">
                  <?php if(isset($latest_reviews)){ foreach($latest_reviews as $review){ ?>
                <li class="item">
                  <div class="product-img">
                      <img src="<?php echo $review['User']['image']; ?>" alt="User Image">
                  </div>
                  <div class="product-info">
                    <a href="javascript:void(0)" class="product-title"><?php echo $review['Restaurant']['name']; ?>
                      <span class="label label-warning pull-right"><?php echo $review['RestaurantsReview']['rating']; ?></span></a>
                        <span class="product-description">
                            <?php echo $review['RestaurantsReview']['text']; ?>
                        </span>
                  </div>
                </li>
                <?php }}else{?>
                <li class="item">No reviews Yet!</li>
                <?php } ?>
                <!-- /.item -->
            ...
            <!-- /.box-body -->
<!--            <div class="box-footer text-center">
              <a href="javascript:void(0)" class="uppercase">View All Reviews</a>
            </div>-->
            <!-- /.box-footer -->
          </div>
          <!-- /.box -->
                ...
                <li class="item">
                  ...
                  <div class="product-info">
                    <a href="javascript:void(0)" class="product-title"><?php echo $product['Product']['name']; ?>
                      <span class="label label-warning pull-right">SAR <?php echo $product['Product']['price']; ?></span></a>
                        <span class="product-description">

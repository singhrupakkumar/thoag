                        ...
                        <div class="strip_list wow fadeIn" data-wow-delay="0.<?php echo $i; ?>s">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-sm-3">
                                    <div class="go_to">
                                        <div>
                                            <?php //$key = 'wt1U5MACWJFTXGenFoZoiLwQGrLgdbHA';
                                                    //$result_id = Security::encrypt($d['id'], $key); ?>
                                            <a href="<?php echo $this->webroot; ?>restaurants/menu/<?php echo $d['id']; ?>" class="btn_1">View Menu</a>
                                            <!--<a href="<?php echo $this->webroot; ?>restaurants/menu/<?php echo urlencode($result_id); ?>" class="btn_1">View Menu</a>-->
                                        </div>
                                    </div>
                                </div>
                            </div><!-- End row-->

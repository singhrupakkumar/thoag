<div class="dishSubcats index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'viewa', $picode['Picode']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edita', $picode['Picode']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'deletea', $picode['Picode']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $picode['Picode']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>

...
<!--		<td><?php //echo h($dishSubcat['DishSubcat']['status']); ?>&nbsp;</td>-->
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'assoview', $dishSubcat['DishSubcat']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'assoedit', $dishSubcat['DishSubcat']['id'])); ?>

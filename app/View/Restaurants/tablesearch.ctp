...
<!--                            <select name="sort_rating" id="sort_rating">
        ...
        <?php } ?>
                                ...
                                <div class="col-md-3 col-sm-3">
                                    <div class="go_to">
                                        <div>
                                            <a href="<?php echo $this->webroot; ?>shop/tableaddress/<?php echo $d['id']; ?>" class="btn_1">Table Reservation </a>
                                        </div>
                                    </div>
                                </div>
                            </div><!-- End row-->
                ...
                foreach ($resdata['Restaurant'] as $d) {
                    ...
                    <div class="grd" style="display:none">
                        <div class="col-md-6 col-sm-6 wow zoomIn" data-wow-delay="0.<?php echo $j; ?>s">
                            <a class="strip_list grid" href="<?php echo $this->webroot; ?>shop/tableaddress/<?php echo $d['id']; ?>">

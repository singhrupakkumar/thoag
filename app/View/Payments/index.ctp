           ...
           <!-- <li>
            ...
            <li>
                ...
                <label class="payment-option" for="po_cc_merchantpage">
                    <img src="<?php echo $this->webroot; ?>images/payfort/cc.png" alt="">
            ...
            <li>
                ...
                <label class="payment-option" for="po_sadad">
                    <img src="<?php echo $this->webroot; ?>images/payfort/sadaad.png" alt="">
         ...
         $(document).ready(function () {
                ...
                $('#btn_continue').click(function () {
                    ...
                    if(paymentMethod == 'cc_merchantpage') {
                        window.location.href = 'payments/conferm?payment_method='+paymentMethod;
                    }

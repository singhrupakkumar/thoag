...
<h2 style="margin-top:0;">Thanks for ordering with Thoag</h2>
...
<tr style="border-bottom:1px solid #ccc; float:left; width:100%;">
    ...
    <td style="text-align:right; color:#000; font-size:15px; float:right;">SAR</td>
</tr>
  <tr>
...
<tr>
	<td>
        ...
        <tr>
          ...
          <tr>
            <td colspan="2" style="float:left; text-align:left;">
            <p style="color:#999;">We hope you had an enjoyable food experience on Thoag. </p>

            </td>
          </tr>
          <tr>
            <td colspan="2" ><img width="400px" src="http://rajdeep.crystalbiltech.com/thoag/mail/banner.png" /></td>
          </tr>
</table>
    </td>
</tr>

        ...
        <div class="row">
            <div class="col-md-12">
                <div class="page-headeing">
                    <h1 class="page-title"><i class="fa fa-bars" aria-hidden="true"></i>Edit Blog</h1>
                </div>
            ...
            <?php $x=$this->Session->flash(); ?>
                    ...
                    <?php echo $this->Form->create('Staticpage',array('id'=>'tab','type'=>'file')); ?> 
                        ...
                        <input type="hidden" class="form-control" value="blog" name="data[Staticpage][position]">
                ...
                <div class="btn-toolbar list-toolbar">
                    ...
                    <a href="<?php echo $this->Html->url(array('controller' => 'Staticpages', 'action' => 'admin_blogindex')); ?>" data-toggle="modal" class="btn btn-danger">Cancel</a>
                </div>
                        </div><!-- End Here -->
